const instrumentRatingRiverside = {
  data: {
    //SEO Header Stuff
    pageTitle: "Instrument Rating at Riverside, CA | NextGen Flight Academy",
    pageDescription:
      "Enhance your flying skills with an Instrument Rating from NextGen Flight Academy in Riverside, CA. Train to fly in any weather with expert guidance and modern simulators.",
    pageKeywords:
      "Instrument Rating, career track flight training, Riverside flight schools, NextGen Flight Academy, flying lessons Riverside CA, flight schools in Riverside CA, pilot training Riverside, Riverside aviation academy, Riverside flight training, intro flight, demonstration flights, Riverside flight academy, NextGen California, learn to fly California, flight training Riverside",
...
export default instrumentRatingRiverside;
