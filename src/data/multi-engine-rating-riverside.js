const multiEngineRiverside = {
  data: {
    //SEO Header Stuff
    pageTitle: "Multi-Engine Rating at Riverside, CA | NextGen Flight Academy",
    pageDescription:
    ...
    pageKeywords:
      "Multi-Engine Rating, career track flight training, Riverside flight schools, NextGen Flight Academy, flying lessons Riverside CA, flight schools in Riverside CA, pilot training Riverside, Riverside aviation academy, Riverside flight training, intro flight, demonstration flights, Riverside flight academy, NextGen California, learn to fly California, flight training Redlands, multi-engine training Riverside",
...
export default multiEngineRiverside;
