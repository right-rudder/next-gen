const certifiedFlightInstructorRiverside = {
  data: {
    //SEO Header Stuff
    pageTitle:
      "Certified Flight Instructor at Riverside, CA | NextGen Flight Academy",
    pageDescription:
      "Become a Certified Flight Instructor with NextGen Flight Academy in Riverside, CA. Train future pilots and build your aviation career with our comprehensive CFI program.",
    pageKeywords:
      "Certified Flight Instructor, career track flight training, Riverside flight schools, NextGen Flight Academy, flying lessons Riverside CA, flight schools in Riverside CA, pilot training Riverside, Riverside aviation academy, Riverside flight training, intro flight, demonstration flights, Riverside flight academy, NextGen California,  learn to fly California, flight training Redlands, CFI training Riverside, certified flight instructor training Riverside",
    ...
    CTAcard: {
      ...
      imageAlt:
        "father-and-son-at-nextgen-flight-academy-redlands-riverside-ca-pilot-training-school",
      link: "/enrollment",
      linkText: "Enroll Now",
...
export default certifiedFlightInstructorRiverside;
