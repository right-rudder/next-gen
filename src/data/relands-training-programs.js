const redlandsTrainingPrograms = {
  data: {
    //SEO Header Stuff
    pageTitle:
      "Training Programs in Redlands, California | NextGen Flight Academy",
    pageDescription:
    ...
    header: {
      ...
      headerH1: `Pilot Training Programs<br><small class="text-muted">Redlands, CA</small>`,
      headerH2:
...
export default redlandsTrainingPrograms;
