const careerTrackRiverside = {
  data: {
    //SEO Header Stuff
    pageTitle:
      "Pilot Career Training at Riverside, CA | NextGen Flight Academy",
    pageDescription:
      "Embark on a professional aviation career with NextGen Flight Academy's Career Track program. Start training at Riverside Municipal Airport (KRAL). From zero experience to professional pilot, our comprehensive training prepares you for opportunities in commercial aviation, airlines, and more.",
    pageKeywords:
      "NextGen Flight Academy, Pilot career training, Riverside Pilot career training, Zero to Hero program, Riverside Zero to Hero program, Professional pilot training, Riverside Professional pilot training, Private Pilot Certificate, Riverside Private Pilot Certificate, Instrument Rating, Riverside Instrument Rating, Commercial Pilot Certificate, Riverside Commercial Pilot Certificate, Multi-Engine Rating, Riverside Multi-Engine Rating, Certified Flight Instructor, Riverside Certified Flight Instructor, Airline Transport Pilot, Riverside Airline Transport Pilot, Flight training programs, Riverside Flight training programs, Aviation career opportunities, Riverside Aviation career opportunities",
    ...
    header: {
      ...
      headerH2:
        "Zero to Hero Flight Training at NextGen Flight Academy in Riverside, CA",
    },
    underHeader: {
    ...
    programs: [
      ...
      },
      {
        ...
        linkTo: {
          title: "Learn More",
          url: "/riverside/instrument-rating",
        },
      ...
      },
      {
        ...
        linkTo: {
          title: "Learn More",
          url: "/riverside/commercial-pilot",
        },
        content:
      ...
      },
      {
        ...
        linkTo: {
          title: "Learn More",
          url: "/riverside/multi-engine-rating",
        },
        content:
      ...
      },
      {
        ...
        linkTo: {
          title: "Learn More",
          url: "/riverside/certified-flight-instructor",
        },
        content:
      ...
      },
      {
        ...
        linkTo: {
          title: "Learn More",
          url: "/riverside/airline-transport-pilot",
        },
        content:
...
export default careerTrackRiverside;
