const highPerformance = {
  data: {
    //SEO Header Stuff
    pageTitle: "High Performance Endorsement | NextGen Flight Academy",
    pageDescription:
      "Master high-performance aircraft with an endorsement from NextGen Flight Academy in Riverside and Redlands, CA. Enhance your flying skills and expand your capabilities.",
    pageKeywords:
