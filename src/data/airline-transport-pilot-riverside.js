const airlineTransportPilotRiverside = {
  data: {
    //SEO Header Stuff
    pageTitle:
      "Airline Transport Pilot at Riverside, CA | NextGen Flight Academy",
    pageDescription:
      "Achieve the highest level of pilot certification with an ATP license from NextGen Flight Academy in Riverside, CA. Become an airline captain with our expert training.",
    pageKeywords:
      "Riverside Airline Transport Pilot, Riverside Airline Transport Pilot training, Airline Transport Pilot, career track flight training, Riverside flight school, NextGen Flight Academy, flying lessons Riverside CA, flight school in Riverside CA, pilot training Riverside, Riverside aviation academy, Riverside flight training, intro flight, demonstration flights, Riverside flight academy, NextGen California, learn to fly California, pilot training Riverside",
...
export default airlineTransportPilotRiverside;
