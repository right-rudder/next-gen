const highPerformanceRiverside = {
  data: {
    //SEO Header Stuff
    pageTitle:
      "High Performance Endorsement at Riverside, CA | NextGen Flight Academy",
    pageDescription:
      "Master high-performance aircraft with an endorsement from NextGen Flight Academy in Riverside, CA. Enhance your flying skills and expand your capabilities.",
    pageKeywords:
      "High-Performance Endorsement, career track flight training, Riverside flight schools, NextGen Flight Academy, flying lessons Riverside CA, flight schools in Riverside CA, pilot training Riverside, Riverside aviation academy, Riverside flight training, intro flight, demonstration flights, Riverside flight academy, NextGen California, learn to fly California, flight training Redlands, high-performance endorsement Riverside, high-performance aircraft training Riverside",
    ...
    program: {
      header: "High Performance Endorsement",
      description: [
        "A High-Performance Endorsement allows you to fly aircraft with engines that produce more than 200 horsepower. This endorsement is essential for pilots who want to operate more powerful and faster aircraft, expanding their flying capabilities and opening new opportunities in aviation. Note: This endorsement is available only if the student supplies the aircraft.",
      ],
    ...
    CTAcard: {
      ...
      linkText: "Enroll Now",
      description:
        "Bring your own high-performance aircraft and earn your endorsement today.",
    },
    underHeader: {
...
export default highPerformanceRiverside;
