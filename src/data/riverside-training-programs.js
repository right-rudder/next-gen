const riversideTrainingPrograms = {
  data: {
    //SEO Header Stuff
    pageTitle:
      "Training Programs in Riverside, California | NextGen Flight Academy",
    pageDescription:
    ...
    pageKeywords:
      "flight school Riverside California, pilot training Riverside Municipal Airport, learn to fly Riverside CA, flight lessons Riverside, aviation school Riverside, flight instruction Riverside, pilot training Riverside California, flight training Riverside CA, aviation training Riverside CA, Riverside Municipal Airport flight school, KRAL flight training, pilot lessons Riverside, flight school near Moreno Valley, aviation training Corona CA, flight training Ontario CA, pilot school Fontana CA, NextGen Flight Academy, Pilot training programs, Flight school Riverside, pilot training Riverside, aviation Riverside california, Private pilot certificate, Instrument rating, Commercial pilot certificate, Multi-engine rating, Certified flight instructor, Airline transport pilot, High performance endorsement, High altitude endorsement, Complex endorsement, Aviation career training, private pilot license, instrument rating, commercial pilot license, airline transport pilot, certified flight instructor, multi-engine rating, complex endorsement, high performance endorsement, CFI training, CFII training, MEI training, ATP training, checkride preparation, ground school, accelerated flight training, part 141 training, part 61 training, zero to hero program, career pilot program, professional pilot training",
    ...
    header: {
      ...
      headerH1: `Pilot Training Programs<br><small class="text-muted">Riverside, CA</small>`,
      headerH2:
...
export default riversideTrainingPrograms;
