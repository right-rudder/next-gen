const commercialPilotRiverside = {
  data: {
    //SEO Header Stuff
    pageTitle:
      "Commercial Pilot Certificate at Riverside, CA | NextGen Flight Academy",
    pageDescription:
      "Turn your passion into a profession with a Commercial Pilot License from NextGen Flight Academy and Learn to Fly in Riverside, CA. Advanced training for a successful aviation career.",
    pageKeywords:
      "Commercial Pilot License, career track flight training, Riverside flight schools, NextGen Flight Academy, flying lessons Riverside CA, flight schools in Riverside CA, pilot training Riverside, Riverside aviation academy, Riverside flight training, intro flight, demonstration flights, Riverside flight academy, NextGen California, learn to fly California, flight training Riverside",
...
export default commercialPilotRiverside;
