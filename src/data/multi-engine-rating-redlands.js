const multiEngineRedlands = {
  data: {
    //SEO Header Stuff
    pageTitle: "Multi-Engine Rating at Redlands, CA | NextGen Flight Academy",
    pageDescription:
      "Enhance your piloting skills with a Multi-Engine Rating from NextGen Flight Academy in Redlands and Redlands, CA. Learn to operate multi-engine aircraft and expand your flying opportunities.",
    pageKeywords:
      "Multi-Engine Rating, career track flight training, Redlands flight schools, NextGen Flight Academy, flying lessons Redlands CA, flight schools in Redlands CA, pilot training Redlands, Redlands aviation academy, Redlands flight training, intro flight, demonstration flights, Redlands flight academy, NextGen California, learn to fly California, flight training Redlands, multi-engine training Redlands",
...
export default multiEngineRedlands;
