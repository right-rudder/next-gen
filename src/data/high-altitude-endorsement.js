const highAltitude = {
  data: {
    //SEO Header Stuff
    pageTitle: "High Altitude Endorsement | NextGen Flight Academy",
    pageDescription:
      "Expand your flying capabilities with a High-Altitude Endorsement from NextGen Flight Academy in Riverside and Redlands, CA. Learn to operate pressurized aircraft safely at high altitudes.",
    pageKeywords:
      "High-Altitude Endorsement, career track flight training, Riverside flight schools, NextGen Flight Academy, flying lessons Riverside CA, flying lessons Redlands CA, flight schools in Riverside CA, flight schools in Redlands CA, pilot training Riverside, Riverside aviation academy, Riverside flight training, intro flight, demonstration flights, Riverside flight academy, NextGen California, learn to fly Redlands, learn to fly California, flight training Redlands, pilot training Redlands",
